...
<html lang="ru">
  ...
  <?php include("header.php"); ?>
    ...
    <main class="main main_delete-catalysts">
      <div class="container">
        <div class="row">
          ...
          <div class="col-6">
            <div class="about-info d-none d-lg-block">
              <div class="about-info__top">
                <div class="big-price mr-10">150 000+</div>
                <h5>удаленных<br />катализаторов в год</h5>
              </div>
    ...
    <section class="section-wrapper d-none d-xl-block">
      <div class="container">
        <div class="select select-custom-js mb-30">
          <div class="select__header map__header h2">Адреса и контакты <br />в <span class="select__current h2">Челябинске</span></div>
        ...
        <div class="row">
          <div class="col-3">
            <div class="map-wrapper tab-wrapper">
              <div class="map-tabs">
              ...
              <div class="map-list tab-content scrollbar-js" data-tab="1">
              ...
              <div class="map-list tab-content scrollbar-js" data-tab="2" style="display: none">
                <div class="map-item">
                  <h5>SDAYKAT</h5>
                  <p class="small-text">ул. Братьев Кашириных, 101</p>
                </div>
    ...
    <!-- popup-thank -->
    <div id="popup-thank__dell" class="popup-thank popup-thank__dell custom-popup mfp-hide">
      <div class="popup-body">
        <div class="popup-primary__title">Спасибо!</div>
        <div class="popup-desc">Менеджер свяжется с вами в ближайшее время</div>
        <div class="popup-desc">Вы отправили заявку в сервис:</div>
        <div class="popup-schedule schedule">
          <div class="schedule-head">Chekpipe</div>
          <div class="schedule-row">
            <img src="assets/img/icons/location-icon-dark.svg" alt="" class="schedule-icon" />
            <div class="schedule-street">ул. Братьев Кашириных, 101</div>
          </div>
          <div class="schedule-row">
            <img src="assets/img/icons/oclock-icon.svg" alt="" class="schedule-icon" />
            <div class="schedule-day"><span>Пн-Пт</span>с 10:00 до 18:00</div>
            <div class="schedule-day"><span>Сб-Вс</span> с 10:00 до 15:00</div>
          </div>
          <div class="schedule-row">
            <img src="assets/img/icons/tell-icon-dark.svg" alt="" class="schedule-icon" />
            <a href="tell:+78005527840" class="schedule-tell">+7 800 552 78 40</a>
            <a href="tell:+78005527840" class="schedule-tell">+7 800 552 78 40</a>
          </div>
        </div>
      </div>
