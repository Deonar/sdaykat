            ...
            <div class="profile-body">
              ...
              <div class="profile-tab__content tab-content" data-tab="1">
                <div id="profile-registration-edit" class="profile-registration-edit profile-blocks">
                  ...
                  <div class="profile-block">
                    <div class="profile-block__head">
                      <div class="profile-block__head-col">
                        ...
                        <div class="profile-block__head-text">Заполните данные о себе. За каждый заполненный пункт мы начисляем % кешбека.</div>
                      </div>
                      <div class="profile-block__head-col">
                  ...
                  <button id="save-info" class="profile__btn-save-info btn btn_hover blue-btn mt-10">сохранить информацию</button>
                </div>
