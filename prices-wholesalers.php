            ...
            <div class="options-item">
              ...
              <div class="options-item__tooltip options-tooltip-js">
                ...
                <div class="options-item__tooltip-body">
                  <div class="options-item__tooltip-content"><span>Процент выплат зависит от катировок LME и общего веса
                      сырья. Актуальную ценовую политику можно посмтреть в предыдущем блоке.</span></div>
                </div>
              </div>
      ...
      <div class="requirement-body">
        ...
        <div class="requirement-list">
          <div href="#" class="requirement-item">
            ...
            <div class="requirement-item__text">Катализаторы не должны быть влажными, допускается естественная влажность
              1-2%</div>
          </div>
          <div href="#" class="requirement-item">
