...
<html lang="ru">
  ...
  ?>
    ...
    <div class="single-section-journal-page header-top__indent">
      <div class="breadcrumbs">
        <div class="container">
          <ul class="breadcrumbs__container">
            ...
            <li class="breadcrumbs__item">
              <span to="/single-article" class="breadcrumbs__link t-control breadcrumbs__link--disabled">Каталитические системы</span>
            </li>
          </ul>
        </div>
      </div>
      ...
      <section class="article-section">
        <div class="container">
          <div class="row article article-section__row">
        ...
        <div class="pagination__wrapp">
          <div class="container">
            <div class="pagination">
              ...
              <a class="pagination__arrow pagination__item" href="#" title="next"></a>
            </div>
