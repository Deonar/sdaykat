...
<body>
  ...
  <div class="main_price-page">
    <section class="section-wrapper catalysts header-top__indent pt-0">
      <div class="container">
        <h2 class="h2 title">
          Какие типы<br />
        ...
        <ul class="prices-ofmetal__list">
          ...
          <li class="prices-ofmetal__item item-ofmetal">
            <div class="item-ofmetal__head">
              ...
              <div class="item-ofmetal__name">Палладий</div>
            </div>
            <div class="item-ofmetal__row">
              <div class="item-ofmetal__quantity">3 - 50 кг</div>
              <div class="item-ofmetal__percent">65%</div>
            ...
            <div class="calculator-options options-calculator">
              <div class="options-item">
                ...
                <div class="options-item__tooltip options-tooltip-js">
                  ...
                  <div class="options-item__tooltip-body">
                    <div class="options-item__tooltip-content">
                      <span>Процент выплат зависит от катировок LME и общего веса сырья. Актуальную ценовую политику
                        можно посмтреть в предыдущем блоке.</span>
                      <!-- <div class="tooltip-close tooltip-close-js"></div> -->
                    </div>
                  </div>
                </div>
              ...
              <div class="options-item">
                ...
                <div class="options-item__tooltip options-tooltip-js">
                  <img src="assets/img/icons/important-icon.svg" alt="" class="options-item__icon" />
                  <div class="options-item__tooltip-body">
                    <div class="options-item__tooltip-content"><span>Процент выплат зависит от катировок LME и общего
                        веса сырья. Актуальную ценовую политику можно посмтреть в предыдущем блоке.</span></div>
                  </div>
                </div>
            ...
            <form class="calculator-form__body main-form main-form__light">
              <div class="main-form__wrapper">
                ...
                <div class="main-form__btn">
                  <a href="#popup-thank-specialist" id="action-btn" class="main-form__submit btn btn_hover primary-btn"
