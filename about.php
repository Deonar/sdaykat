        ...
        <div class="row about-company__row-statistics section-wrapper pt-0">
          <div class="col-sm-12 col-lg-6">
            <div class="about-company__histoty">
              <p>Еще 15 лет назад об электромобилях никто не говорил всерьез, но сегодня уже каждый знает, что это, а многие готовы приобрести за любые деньги.</p>
            </div>
        ...
        <div class="row about-company__row-target section-wrapper pb-0" id="mission">
          <div class="col-12 col-sm-6 col-xl-6">
            <div class="about-company__target">
              ...
              <div class="about-company__target-text">Сделать рынок каталитического сырья более простым и понятным обывателям и предложить самые лояльные и привлекательные условия по сотрудничеству.</div>
            </div>
          </div>
          <div class="col-12 col-sm-6 col-xl-6">
            <div class="about-company__target">
        ...
        <div class="row vacancy-row">
          <div class="col-sm-12 col-md-6">
            <div class="vacancy-item">
              ...
              <div class="vacancy-item__text">Вакансия подразумевает что работник будет обрабатывать заявки, которые будут приходить ему на телефон (ничего самому искать не надо).</div>
        ...
        <form class="popup-form main-form main-form__light">
          <div class="main-form__wrapper">
            ...
            <div class="main-form__btn">
              <a href="#popup-thank" class="main-form__submit btn btn_hover border-gray-btn popup" type="button">отправить отклик</a>
            </div>
          </div>
