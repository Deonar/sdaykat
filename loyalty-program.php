...
<body>
  ...
  <div class="loyalty-program-page header-top__indent">
    ...
    <section class="bonuses loyalty-programs section-wrapper pt-0">
      <div class="container">
        <div class="bonuses-body">
          <ul class="bonuses-list">
            <li class="bonuses-item">
              ...
              <ul class="bonuses-item__list-bonuses list-bonuses">
                <li class="list-bonuses__item">
                  <div class="list-bonuses__item-num">01</div>
                  <div class="list-bonuses__item-text">Совершаете 10 сделок</div>
                </li>
                <li class="list-bonuses__item">
                  <div class="list-bonuses__item-num">02</div>
                  <div class="list-bonuses__item-text">За каждую 10 сделку начисляется кэшбек в размере 5% от общей
                    суммы</div>
                </li>
              </ul>
            </li>
            ...
            <li class="bonuses-item">
              ...
              <ul class="bonuses-item__list-bonuses list-bonuses">
                ...
                <li class="list-bonuses__item">
                  <div class="list-bonuses__item-num">03</div>
                  <div class="list-bonuses__item-text">За каждую 10 сделку начисляется кэшбек в размере 5% от общей
                    суммы</div>
                </li>
              </ul>
    ...
    <section class="loyalty-instruction section-wrapper">
      <div class="container">
        <h2 class="loyalty-programs__title primary-title">
          Как стать участником <br />
          программы лояльности?
        </h2>
        <div class="loyalty-instruction__body">
          <div class="loyalty-instruction__steps">
            <ul class="steps__list">
              ...
              <li class="steps__item">
                <div class="steps__item-num">03</div>
                <div class="steps__item-title">Мы получаем дотации от утилизации</div>
                <div class="steps__item-text">Неисправные и старые катализаторы сдаем на завод.</div>
              </li>
              <li class="steps__item">
                <div class="steps__item-num">04</div>
                <div class="steps__item-title">Мы получаем дотации от утилизации</div>
                <div class="steps__item-text">Наши клиенты получают качественную бесплатную услугу, а мы — благодарные
                  отзывы, дополнительный пиар и еще больше клиентов.</div>
              </li>
          ...
          <div class="loyalty-instruction__card">
        ...
        <ul class="selectCity__list scrollbar scrollbar-js" id="city-list">
          <li class="selectRegion__item-ofmetal">
            ...
            <ul class="selectRegion__item-ofmetal-list">
              <li class="selectCity__item-ofmetal" data-city="Екатеринбург" data-region="Свердловкая область">
                Екатеринбург</li>
              <li class="selectCity__item-ofmetal" data-city="Пышма" data-region="Свердловкая область">Пышма</li>
              <li class="selectCity__item-ofmetal" data-city="Первоуральск" data-region="Свердловкая область">
                Первоуральск</li>
              <li class="selectCity__item-ofmetal" data-city="Реж" data-region="Свердловкая область">Реж</li>
              <li class="selectCity__item-ofmetal" data-city="Артемовский" data-region="Свердловкая область">Артемовский
              </li>
              <li class="selectCity__item-ofmetal" data-city="Березовский" data-region="Свердловкая область">Березовский
              </li>
              ...
              <li class="selectCity__item-ofmetal" data-city="Нижний Тагил" data-region="Свердловкая область">Нижний
                Тагил</li>
            </ul>
          </li>
          <li class="selectRegion__item-ofmetal">
